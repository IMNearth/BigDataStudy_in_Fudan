...
from pkg.eval import voc_eval
from pkg.utils.datasets import *
from pkg.utils.gpu import *
from pkg.utils.data_augment import *
...
class Evaluator(object):
    def __init__(self, model, visiual=True):
        ...
        self.pred_result_path = os.path.join(cfg.PROJECT_PATH, 'outputs', 'results')
        self.val_data_path = os.path.join(cfg.TEST_DATA_PATH, 'VOC2007')
    ...
    def APs_voc(self, multi_test=False, flip_test=False, iou_thresh=0.5):
        ...
        for img_ind in tqdm(img_inds):
            ...
            for bbox in bboxes_prd:
                ...
                with open(os.path.join(self.pred_result_path, 'voc_test_' + class_name + '.txt'), 'a') as f:
                    f.write(s)

        return self.__calc_APs(iou_thresh=iou_thresh)
    ...
    def __calc_APs(self, iou_thresh=0.5, use_07_metric=False):
        ...
        :return:dict{cls:ap}
        """
        filename = os.path.join(self.pred_result_path, 'voc_test_{:s}.txt')
