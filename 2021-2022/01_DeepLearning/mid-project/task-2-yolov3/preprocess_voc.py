...
def parse_voc_annotation(data_path, file_type, anno_path, use_difficult_bbox=False, which_track='Main'):
    """
    ...
    img_inds_file = os.path.join(data_path, 'ImageSets', which_track, file_type + '.txt')
...
if __name__ =="__main__":
    ...
    train_data_path_2007 = "../datasets/voc/VOC2007"
    train_data_path_2012 = "../datasets/voc/VOC2012_trainval"
    ...
    test_data_path_2007 = "../datasets/voc/VOC2007"
    ...
    # 2012 -- trainval : 11540
    # 2007 -- trainval :  5011  | test : 4952
    # TOTAL - trainval : 16551  | test : 4952
